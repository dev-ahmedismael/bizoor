<nav>
        ...
        <div class="container  flex justify-end">
            <div class="flex gap-10">
                ...
                <div class="flex gap-2 items-center">
                    ...
                    <p dir="ltr">+1 225 1234</p>
                </div>

                <!-- Email -->
                <div class="flex gap-2 items-center">
                    <i class="fa-solid fa-envelope"></i>
                    <p> contact@bizoor.com</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/{{app()->getLocale()}}" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="/assets/images/logo/logo.jpg" class="h-12" alt="Flowbite Logo" />
            </a>
            <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700" id="language-dropdown-menu">
                    <ul class="py-2 font-medium" role="none">
                        ...
                        <li>
                            <a href="/ar" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                                <div class="inline-flex items-center gap-2">
                                    <img src="/assets/images/flags/egypt.png" alt="Egypt Flag" class="w-4 h-4" />
                                    العربية
                                </div>
                            </a>
                        </li>
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li class="hover:bg-yellow-400 hover:text-white py-1 px-3 hover:py-1 hover:px-3">
